...
<head>
    ...
    <link href="<%=request.getContextPath()%>/assets/css/layouts/menu.css" rel="stylesheet" />
    ...
    <div  class="left-bar-color offcanvas offcanvas-end" tabindex="-1" id="left-menu" aria-labelledby="left-menuLabel">
        ...
        <div class="offcanvas-end">
            ...
            <div class="list-group">
                ...
                <a href="#" class="my-2 list-group-item list-group-item-action left-bar-color"><i class="fa-solid fa-right-from-bracket"></i> Salir</a>
